...
const zh_CN = {
    ...
    "SuccessfulApplication.What.causes.the.application to fail":"什么原因导致申请无法通过?",
    "SuccessfulApplication.Your.application.has.been.submitted.successfully.We.will.deal.with.it.as.soon.as.possible.Please.be.patient":"您的申请已提交成功，我们将尽快处理，请耐心等待",
    "SuccessfulApplication.What.are.the.special.privileges.of.the agent?":"代理商有哪些特权？",
    "SuccessfulApplication.What.are.the.suppliers'. privileges?":"供应商有哪些特权？",
    "SuccessfulApplication.Offshore.transport":"离岸运输",
    "SuccessfulApplication.Transport.to.the. port":"主营产品",
