...
const en_US = {
    ...
    "app.input.relname": "Please input your relname",
    "app.input.certification": "Please select type of certification",
    "app.input.cardnumber": "Please input card number",
    "app.idaddress": "id address",
    ...
    "app.soes": "State-owned enterprise",
    "app.private": "Private",
    "app.state": "State",
    ...
    "post.demand.subject": "Demand Subject",
    "add.cart.success": "add cart successfully",
    "cart.cart": "My Cart",
    ...
    "cart.delete_warn": "delete successfully",
    "cart.select.all": "All",
    ...
    "mine.product.param": "specification parameters",
    ...
    "product.edite.attention": "Prodoct attentions",
    "product.edite.application": "Prodoct application",
    "product.edite.details": "Prodoct details",
    "product.edite.size": "Prodoct size",
    "product.edite.introduce.type": "Classification of description",
    "product.edite.content.type": "Content type",
    "product.edite.text": "text",
    "product.edite.picture": "picture",
    "product.edite.complete.info": "please complete information",
    "product.edite.recommend": "it is recommended to upload a picture with a width of 750px,and the picture size is no more than 2M",
    ...
    "persondata.type.certification": "Type of certificate",
    ...
    "register.register.name": "account",
    ...
    "authen.authen.retrieve": "Retrieve password",
    "authen.authen.complete": "Complete",
    ...
    "certif.company.website": "Company website",
    "certif.company.website_warn": "Please enter the company website",
    "certif.company.nature": "Company nature",
    "certif.company.industry": "industry",
    ...
    "certif.submit": "提交",
    "certif.certif.type": "Certif type",
    "certif.certif.card": "Identification card",
    "certif.certif.green_card": "Green card",
    "certif.certif.card_number": "Certifcate NO",
    "certif.certif.license": "Business license",
    ...
    "app.phone.verified_info": "You've already binded your phone number",
    "app.email.verifi_info": "Email had binded can be used for login",
    "app.email.verifi_infoed": "Email is not binded, please go to binding",
    "app.phone.verified_infoed": "The phone is not binded, please binding it in time",
