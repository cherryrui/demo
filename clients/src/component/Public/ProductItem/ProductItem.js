...
class ProductItem extends React.Component {
    render() {
        return <div className={this.props.className}>
			<Link to={"page/product-detail/"+this.props.product.pid} className={css.table_product}>
                <img src={this.props.product.coverUrl?this.props.product.coverUrl+"@100w_100h_1e_1c.png":"../img/no_picture.jpg"}/>
